...
get_header();
?>	
	<div class="preview-thumbnail preview-hide preview-thumbnail--mobile" style="background-image: url('<?php echo $review_home_image['url']; ?> ') "  >
		<div></div>
	...
	<div class="preview-thumbnail preview-hide preview-thumbnail--desktop" style="background: url('<?php  echo $review_home_image['url']; ?>') 50% 0 no-repeat fixed;" data-type="background" data-speed="5" >
		<div></div>
		<div class="preview-thumbnail__content container">
			<h1 class="preview-thumbnail__title" style="color: #E9C87B;"><?php the_archive_title(); ?></h1>
		</div>

...
const carousel = $('.featured-posts__carousel');
    //Review Carousel    
    carousel.slick({
        slidesToShow: 1,
        arrows: false,
    ...
    if ($('body').hasClass('category-blogs')) {
        ...
        $('.fa-chevron-down').addClass("is-blog");
        ...
        $('.fa-chevron-down').addClass("is-list");
        ...
        $('.preview-thumbnail__title').css("color", review);
        $('.fa-chevron-down').addClass("is-review");
    ...
    if (navigator.userAgent.match(/(iPod|iPhone|iPad|Android)/)) {
            $('.preview-thumbnail--mobile').removeClass('preview-hide');
    } else {
            $('.preview-thumbnail--desktop').removeClass('preview-hide');
    }

    //Search iOS
    if (navigator.userAgent.match(/(iPod|iPhone|iPad)/)) {
        $('.search-submit').addClass('search-submit-ios');
    } 
